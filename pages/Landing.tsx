      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center space-x-4">
            <button onClick={() => navigate('/app')} className="text-slate-300 hover:text-white text-sm font-medium transition-colors">
              Sign In
            </button>
            <Button size="sm" onClick={() => navigate('/app')}>Launch App</Button>
          </div>
        ...
        <div className="md:hidden glass-panel border-b border-white/10 absolute w-full">
          <div className="px-4 pt-4 pb-6 space-y-2">
            ...
            <div className="pt-4 mt-4 border-t border-white/10">
              <Button fullWidth onClick={() => navigate('/app')}>Launch App</Button>
            </div>
          </div>
        </div>
      )}
    ...
    <div className="relative pt-32 pb-20 lg:pt-48 lg:pb-40 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
          <Button size="lg" onClick={() => navigate('/app/m/snap')}>
            Try Snap &amp; Source
            <ChevronRight className="ml-2 w-4 h-4" />
          </Button>
          <Button size="lg" variant="outline" onClick={() => navigate('/app/s/inbox')}>
            Open Supplier Inbox
          </Button>
        </div>
  ...
  <div className="grid lg:grid-cols-2 min-h-[600px]">
    ...
    <div id="manufacturers" className="relative p-12 lg:p-24 flex flex-col justify-center border-b lg:border-b-0 lg:border-r border-white/5 bg-[#020617] overflow-hidden group">
      ...
      <div className="relative z-10">
        ...
        <Button variant="outline" className="w-fit" onClick={() => navigate('/app/m/snap')}>
          Open Manufacturer Workspace <ArrowRight className="ml-2 w-4 h-4" />
        </Button>
      </div>
    </div>
    ...
    <div id="suppliers" className="relative p-12 lg:p-24 flex flex-col justify-center bg-[#060b19] overflow-hidden group">
      ...
      <div className="relative z-10">
        ...
        <Button variant="secondary" className="w-fit" onClick={() => navigate('/app/s/inbox')}>
          Open Supplier Workspace <ArrowRight className="ml-2 w-4 h-4" />
        </Button>
      </div>
    </div>
  </div>
        ...
        <div className="glass-panel rounded-2xl overflow-hidden border border-white/10 shadow-2xl relative">
          ...
          <div className="grid md:grid-cols-5 min-h-[500px]">
             ...
             <div className="col-span-3 p-8 md:p-10 bg-[#0f172a]">
                ...
                <form className="space-y-5" onSubmit={(e) => { e.preventDefault(); navigate(activeTab === 'manufacturer' ? '/app/m/snap' : '/app/s/inbox'); }}>
                  ...
                  <Button 
                    ...
                    className="mt-6"
                  >
                    {activeTab === 'manufacturer' ? 'Enter Manufacturer Workspace' : 'Enter Supplier Workspace'}
                  </Button>
                </form>
             </div>
          </div>
